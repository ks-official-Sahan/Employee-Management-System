...
namespace Employee_Management_System
{
    public partial class AdminLogin : Form
    {
        ...
        private void openAdminDashboard(ewision.developer.model.User user)
        {
            ...
            else
            {
                ...
                if (resultSet.Read())
                {
                    if (((string)resultSet["password"]).Equals(password))
                    {
                        ...
                        {
                            ewision.developer.model.User user;
                            user = new ewision.developer.model.User(((int)resultSet["uid"]).ToString(), (string)resultSet["fname"], (string)resultSet["lname"], (string)resultSet["email"], (string)resultSet["mobile"], resultSet["dob"]);
