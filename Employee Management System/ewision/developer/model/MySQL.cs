...
namespace Employee_Management_System.ewision.developer.model
{
    class MySQL
    {
        ...
        private static MySqlConnection GetConnection()
        {
            ...
            string connectionString = "datasource=localhost;port=3306;username=kaveesh;password=kaveesh123;database=EMS";
